...
namespace _15_1_FirmaBruinsma
{
    public partial class Form1 : Form
    {
        ...
        //Hier wordt gecheckt welk item in de listbox geselecteerd is en koppelt dat terug in de klantid.
        ...
        {
           //Roept de database op in de listbox wanneer de form wordt gestart. 
           LeesGegevens();
        }
      
        //button waar de nieuwe klant in de database wordt toegevoegd.
        private void btnNieuweKlant_Click(object sender, EventArgs e)
        {
            FrmKlantInvoer frm = new FrmKlantInvoer();
            frm.ShowDialog();
        }
        //leest de klantdetails van een specifieke klant uit vanaf de database en voegt ze toe aan de tekstboxen
        ...
        //leest de gegevens van alle klanten uit uit de database.
        ...
        //hier worden de klantgegevens uit de database gehaald, wordt het veranderd en wordt het daarna weer terug in de database gestopt.
        ...
        //Hiermee worden de klantgegevens uit de database verwijderd.
